...
export default function DeleteConfirmationDialog({ visible, onHide, onConfirm, selectedProjects }) {
    return (
        <Dialog
            visible={visible}
            style={{ width: '450px' }}
            ...
            <div className="confirmation-content">
                ...
                <span>
                    {selectedProjects?.length > 1
                        ...
                        : `Are you sure you want to delete "${selectedProjects?.[0]?.name}"'s project?`}
                </span>
            </div>
        </Dialog>
    );
